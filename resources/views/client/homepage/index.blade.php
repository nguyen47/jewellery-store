...
<section id="content">
			...
			<div class="wrap-item" data-navigation="true" data-transition="fade" data-itemscustom="[[0,1]]">
				<div class="item-slider item-slider2">
					<div class="banner-thumb">
						<a href="#"><img src="{{asset('assets/client/images/home/jewelry2/slide1.jpg')}}" alt="" /></a>
					</div>
				...
				<div class="item-slider item-slider2">
					<div class="banner-thumb">
						<a href="#"><img src="{{asset('assets/client/images/home/jewelry2/slide2.jpg')}}" alt="" /></a>
					</div>
				...
				<div class="item-slider item-slider2">
					<div class="banner-thumb">
						<a href="#"><img src="{{asset('assets/client/images/home/jewelry2/slide3.jpg')}}" alt="" /></a>
					</div>
					<div class="banner-info animated text-center" data-animated="tada">
						<h2 class="title48 play-font font-normal text-uppercase dark">happy new year</h2>
						<h3 class="title18 play-font font-italic dark"><strong>up to 70% all items</strong><br>Two for Joy Jewelry creates meaningful jewelry "of the </h3>
		...
		<div class="container">
				...
				<div class="row">
					<div class="col-md-4 col-sm-4 col-xs-12">
						<div class="item-adv2 banner-adv zoom-image fade-out-in">
							<a href="#" class="adv-thumb-link"><img src="{{asset('assets/client/images/home/jewelry/adv1.jpg')}}" alt="" /></a>
							<div class="banner-info text-center">
								<h2 class="white title30 play-font font-italic">Bracelets</h2>
								<p class="desc white opaci">Lorem ipsum dolor sit amet conse ctetur adipisicing elit, sed do eiusmod</p>
								<a href="#" class="border-button white title14">shop now</a>
							</div>
						</div>
					</div>
					<div class="col-md-4 col-sm-4 col-xs-12">
						<div class="item-adv2 banner-adv zoom-out">
							<a href="#" class="adv-thumb-link">
								<img src="{{asset('assets/client/images/home/jewelry/adv2.jpg')}}" alt="" />
								<img src="{{asset('assets/client/images/home/jewelry/adv2.jpg')}}" alt="" />
							</a>
							<div class="banner-info text-center">
								<h2 class="dark title30 play-font font-italic">Rings</h2>
								<p class="desc dark opaci">Lorem ipsum dolor sit amet conse ctetur adipisicing elit, sed do eiusmod</p>
								<a href="#" class="border-button dark title14">shop now</a>
							</div>
						</div>
					</div>
					<div class="col-md-4 col-sm-4 col-xs-12">
						<div class="item-adv2 banner-adv zoom-image fade-out-in">
							<a href="#" class="adv-thumb-link"><img src="{{asset('assets/client/images/home/jewelry/adv3.jpg')}}" alt="" /></a>
							<div class="banner-info text-center">
								<h2 class="white title30 play-font font-italic">Earrings</h2>
								<p class="desc white opaci">Lorem ipsum dolor sit amet conse ctetur adipisicing elit, sed do eiusmod</p>
								<a href="#" class="border-button white title14">shop now</a>
							</div>
						</div>
			...
			<div class="block-cate2">
				<div class="title-box2 text-center">
					...
					<img src="{{asset('assets/client/images/home/jewelry2/line-black.png')}}" alt="" />
				</div>
				<div class="list-cat2">
					<div class="row">
						<div class="col-md-3 col-sm-6 col-xs-6">
							<div class="item-cat2 text-center">
								<div class="cat-thumb"><a href="#"><img src="{{asset('assets/client/images/home/jewelry2/cat1.png')}}" alt="" /></a></div>
								<div class="cat-info">
						...
						<div class="col-md-3 col-sm-6 col-xs-6">
							<div class="item-cat2 text-center">
								<div class="cat-thumb"><a href="#"><img src="{{asset('assets/client/images/home/jewelry2/cat2.png')}}" alt="" /></a></div>
								<div class="cat-info">
						...
						<div class="col-md-3 col-sm-6 col-xs-6">
							<div class="item-cat2 text-center">
								<div class="cat-thumb"><a href="#"><img src="{{asset('assets/client/images/home/jewelry2/cat3.png')}}" alt="" /></a></div>
								<div class="cat-info">
						...
						<div class="col-md-3 col-sm-6 col-xs-6">
							<div class="item-cat2 text-center">
								<div class="cat-thumb"><a href="#"><img src="{{asset('assets/client/images/home/jewelry2/cat4.png')}}" alt="" /></a></div>
								<div class="cat-info">
			...
			<div class="container">
				...
				<div class="box-best-seller9">
					<ul class="list-inline-block title-list-tab text-center style-white">
						<li class="active"><a href="{{asset('assets/client/#tab1')}}" data-toggle="tab">Bracelets</a></li>
						<li><a href="{{asset('assets/client/#tab2')}}" data-toggle="tab">Rings</a></li>
						<li><a href="{{asset('assets/client/#tab1')}}" data-toggle="tab">Earrings</a></li>
					</ul>
								...
								<div class="wrap-item hide-navi" data-pagination="false" data-navigation="true" data-itemscustom="[[0,1],[560,2],[768,3],[990,4]]">
									<div class="item-product item-product4 text-center">
										<div class="product-thumb">
											<a href="#" class="product-thumb-link zoom-thumb"><img src="{{asset('assets/client/images/photos/jewelry/dark-light-jewelry-01.jpg')}}" alt=""></a>
											<a href="{{asset('assets/client/quick-view.html')}}" class="quickview-link fancybox.iframe title12 round white"><i class="fa fa-search"></i></a>
										</div>
										<div class="product-info">
											...
											<div class="product-extra-link4 title18">
												<a href="{{asset('assets/client/compare-product.html')}}" class="compare-link inline-block black fancybox fancybox.iframe"><i class="icon ion-ios-loop-strong"></i><span class="title10 white text-uppercase">Compare</span></a>
									...
									<div class="item-product item-product4 text-center">
										<div class="product-thumb">
											<a href="#" class="product-thumb-link zoom-thumb"><img src="{{asset('assets/client/images/photos/jewelry/dark-light-jewelry-02.jpg')}}}" alt=""></a>
											<a href="{{asset('assets/client/quick-view.html')}}" class="quickview-link fancybox.iframe title12 round white"><i class="fa fa-search"></i></a>
									...
									<div class="item-product item-product4 text-center">
										<div class="product-thumb">
											<a href="#" class="product-thumb-link zoom-thumb"><img src="{{asset('assets/client/images/photos/jewelry/dark-light-jewelry-03.jpg')}}" alt=""></a>
											<a href="{{asset('assets/client/quick-view.html')}}" class="quickview-link fancybox.iframe title12 round white"><i class="fa fa-search"></i></a>
										</div>
										<div class="product-info">
											<h3 class="title14 product-title"><a href="#" class="black">Blue ring in ged palladium</a></h3>
									...
									<div class="item-product item-product4 text-center">
										<div class="product-thumb">
											<a href="#" class="product-thumb-link zoom-thumb"><img src="{{asset('assets/client/images/photos/jewelry/dark-light-jewelry-04.jpg')}}" alt=""></a>
											<a href="{{asset('assets/client/quick-view.html')}}" class="quickview-link fancybox.iframe title12 round white"><i class="fa fa-search"></i></a>
										</div>
										<div class="product-info">
											<h3 class="title14 product-title"><a href="#" class="black">Blue ring in ged palladium</a></h3>
											...
											<div class="product-extralink4 title18">
												<a href="{{asset('assets/client/compare-product.html')}}" class="compare-link inline-block black fancybox fancybox.iframe"><i class="icon ion-ios-loop-strong"></i><span class="title10 white text-uppercase">Compare</span></a>
												<a href="#" class="addcart-link black inline-block"><i class="icon ion-bag"></i><span class="title10 white text-uppercase">Add to cart</span></a>
												<a href="#" class="wishlist-link black inline-block"><i class="icon ion-android-favorite-outline"></i><span class="title10 white text-uppercase">Wishlist</span></a>
											</div>
									...
									<div class="item-product item-product4 text-center">
										<div class="product-thumb">
											<a href="#" class="product-thumb-link zoom-thumb"><img src="{{asset('assets/client/images/photos/jewelry/dark-light-jewelry-05.jpg')}}" alt=""></a>
											<a href="{{asset('assets/client/quick-view.html')}}" class="quickview-link fancybox.iframe title12 round white"><i class="fa fa-search"></i></a>
										</div>
										<div class="product-info">
											<h3 class="title14 product-title"><a href="#" class="black">Blue ring in ged palladium</a></h3>
									...
									<div class="item-product item-product4 text-center">
										<div class="product-thumb">
											<a href="#" class="product-thumb-link zoom-thumb"><img src="{{asset('assets/client/images/photos/jewelry/dark-light-jewelry-06.jpg')}}" alt=""></a>
											<a href="{{asset('assets/client/quick-view.html')}}" class="quickview-link fancybox.iframe title12 round white"><i class="fa fa-search"></i></a>
										</div>
										<div class="product-info">
											<h3 class="title14 product-title"><a href="#" class="black">Blue ring in ged palladium</a></h3>
			...
			<div class="row">
				<div class="col-sm-8 col-xs-12">
					<div class="banner-adv banner-countdown gray-image zoom-image jewelry-coundown2">
						<a href="#" class="adv-thumb-link"><img src="{{asset('assets/client/images/home/jewelry2/deal.jpg')}}" alt="" /></a>
						<div class="banner-info text-center">
				...
				<div class="col-sm-4 col-xs-12">
					<div class="banner-adv diamond-collect banner-adv2 zoom-rotate">
						<a href="#" class="adv-thumb-link"><img src="{{asset('assets/client/images/home/jewelry2/diamond.jpg')}}" alt=""></a>
						<div class="banner-info">
							<h3 class="title18 dark font-italic play-font">Diamond</h3>
				...
				<div class="row">
					<div class="col-sm-4 col-xs-12">
						<div class="item-cat-jewelry2 text-center">
							<a href="#" class="pop"><img src="{{asset('assets/client/images/home/jewelry2/ring1.jpg')}}" alt="" /></a>
							<h3 class="title18 play-font font-italic"><a href="#" class="dark">Wedding Jewelry</a></h3>
							<img class="line-icon" src="{{asset('assets/client/images/home/jewelry2/line-black.png')}}" alt="" />
							<a href="#" class="opacity dark text-uppercase wobble-top">Shop Now</a>
						</div>
					</div>
					<div class="col-sm-4 col-xs-12">
						<div class="item-cat-jewelry2 text-center">
							<a href="#" class="pop"><img src="{{asset('assets/client/images/home/jewelry2/ring2.jpg')}}" alt="" /></a>
					...
					<div class="col-sm-4 col-xs-12">
						<div class="item-cat-jewelry2 text-center">
							<a href="#" class="pop"><img src="{{asset('assets/client/images/home/jewelry2/ring3.jpg')}}" alt="" /></a>
		...
		<div class="product-featured-jewelry2">
			<div class="container">
				<div class="title-box2 text-center">
					<h2 class="title24 dark play-font font-italic">Featured Products</h2>
					<img src="{{asset('assets/client/images/home/jewelry2/line-black.png')}}" alt="" />
				</div>
				<div class="product-slider">
				...
				<div class="row">
					<div class="col-sm-6 col-xs-12">
						<div class="banner-adv zoom-image line-scale item-adv-jewelry2 style1">
							<a href="#" class="adv-thumb-link"><img src="{{asset('assets/client/images/home/jewelry2/ads1.jpg')}}" alt="" /></a>
							<div class="banner-info">
								<h2 class="title60 play-font white text-uppercase">jewelry</h2>
								<h3 class="title30 white play-font text-uppercase">Rings</h3>
								<h4 class="title18 play-font font-italic white opacity">Sophisticated design by Fanbong</h4>
								<hr class="white" />
						...
						<div class="banner-adv item-adv-jewelry2 zoom-image line-scale style1">
							<a href="#" class="adv-thumb-link"><img src="{{asset('assets/client/images/home/jewelry2/ads2.jpg')}}" alt="" /></a>
							<div class="banner-info">
								<h3 class="title30 dark play-font text-uppercase">Bangles</h3>
								<h4 class="title18 play-font font-italic dark opaci">Diamonds & Gold</h4>
								<hr class="dark" />
					...
					<div class="col-sm-6 col-xs-12">
						<div class="banner-adv item-adv-jewelry2 style2 zoom-rotate overlay-image">
							<a href="#" class="adv-thumb-link"><img src="{{asset('assets/client/images/home/jewelry2/ads3.jpg')}}" alt="" /></a>
							<div class="banner-info">
								<h3 class="title30 white play-font text-uppercase">Product Custom</h3>
					...
					<div class="wrap-item" data-pagination="false" data-itemscustom="[[0,1],[640,2],[990,3]]">
						<div class="item-post item-post-grid">
							<div class="post-thumb banner-adv zoom-image overlay-image">
								<a href="#" class="adv-thumb-link"><img src="{{asset('assets/client/images/photos/blog/dark-light-store-blog-01.jpg')}}" alt=""></a>
							</div>
							<div class="post-info">
						...
						<div class="item-post item-post-grid">
							<div class="post-thumb banner-adv zoom-image overlay-image">
								<a href="#" class="adv-thumb-link"><img src="{{asset('assets/client/images/photos/blog/dark-light-store-blog-02.jpg')}}" alt=""></a>
							</div>
							<div class="post-info">
								<h3 class="title18 play-font font-italic post-title"><a href="#" class="dark">Slide image Post format</a></h3>
								<ul class="list-inline-block post-meta-data">
						...
						<div class="item-post item-post-grid">
							<div class="post-thumb banner-adv zoom-image overlay-image">
								<a href="#" class="adv-thumb-link"><img src="{{asset('assets/client/images/photos/blog/dark-light-store-blog-03.jpg')}}" alt=""></a>
							</div>
							<div class="post-info">
								<h3 class="title18 play-font font-italic post-title"><a href="#" class="dark">Slide image Post format</a></h3>
								<ul class="list-inline-block post-meta-data">
						...
						<div class="item-post item-post-grid">
							<div class="post-thumb banner-adv zoom-image overlay-image">
								<a href="#" class="adv-thumb-link"><img src="{{asset('assets/client/images/photos/blog/dark-light-store-blog-04.jpg')}}" alt=""></a>
							</div>
							<div class="post-info">
								<h3 class="title18 play-font font-italic post-title"><a href="#" class="dark">Slide image Post format</a></h3>
								<ul class="list-inline-block post-meta-data">
		...
		<div class="testimo-jewelry2 parallax" data-image="{{asset('assets/client/images/home/jewelry2/parallax.jpg')}}">
			<div class="container">
				<div class="title-box2 text-center">
					<h2 class="title24 white play-font font-italic">What People Say</h2>
					<img src="{{asset('assets/client/images/home/jewelry2/line-white.png')}}" alt="" />
				</div>
