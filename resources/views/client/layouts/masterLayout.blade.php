...
<!-- Mirrored from demo.7uptheme.com/html/bw-store/ by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 27 Feb 2019 14:24:21 GMT -->
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('assets/client/css/libs/font-awesome.min.css')}}"/>
	<link rel="stylesheet" type="text/css" href="{{asset('assets/client/css/libs/ionicons.min.css')}}"/>
	<link rel="stylesheet" type="text/css" href="{{asset('assets/client/css/libs/bootstrap.min.css')}}"/>
	<link rel="stylesheet" type="text/css" href="{{asset('assets/client/css/libs/bootstrap-theme.min.css')}}"/>
	<link rel="stylesheet" type="text/css" href="{{asset('assets/client/css/libs/jquery.fancybox.min.css')}}"/>
	<link rel="stylesheet" type="text/css" href="{{asset('assets/client/css/libs/jquery-ui.min.css')}}"/>
	<link rel="stylesheet" type="text/css" href="{{asset('assets/client/css/libs/owl.carousel.min.css')}}"/>
	<link rel="stylesheet" type="text/css" href="{{asset('assets/client/css/libs/owl.transitions.min.css')}}"/>
	<link rel="stylesheet" type="text/css" href="{{asset('assets/client/css/libs/jquery.mCustomScrollbar.min.css')}}"/>
	<link rel="stylesheet" type="text/css" href="{{asset('assets/client/css/libs/owl.theme.min.css')}}"/>
	<link rel="stylesheet" type="text/css" href="{{asset('assets/client/css/libs/animate.min.css')}}"/>
	<link rel="stylesheet" type="text/css" href="{{asset('assets/client/css/libs/hover.min.css')}}"/>
	<link rel="stylesheet" type="text/css" href="{{asset('assets/client/css/theme.css')}}" media="all"/>
	<link rel="stylesheet" type="text/css" href="{{asset('assets/client/css/responsive.css')}}" media="all"/>
	<link rel="stylesheet" type="text/css" href="{{asset('assets/client/css/browser.css')}}" media="all"/>
												...
												<div class="row">
													<div class="col-md-6 col-sm-6 col-xs-12">
														<div class="mega-menu-home">
															<h2 class="title18 play-font font-italic dark">Home Jewelry</h2>
															<ul class="list-none">
																<li><a href="{{asset('assets/client/home-jewelry-light.html')}}" class="silver">Home - v1<span class="title12">(Light version)</span></a></li>
																<li><a href="{{asset('assets/client/home-jewelry-dark.html')}}" class="silver">Home - v1<span class="title12">(Dark version)</span></a></li>
																<li><a href="{{asset('assets/client/home-jewelry-02.html')}}" class="silver">Home - v2</a></li>
																<li><a href="{{asset('assets/client/home-jewelry-03.html')}}" class="silver">Home - v3</a></li>
																<li><a href="{{asset('assets/client/home-jewelry-04.html')}}" class="silver">Home - v4</a></li>
																<li><a href="{{asset('assets/client/home-jewelry-05.html')}}" class="silver">Home - v5</a></li>
																<li><a href="{{asset('assets/client/home-jewelry-06.html')}}" class="silver">Home - v6</a></li>
															</ul>
														</div>
													</div>
													<div class="col-md-6 col-sm-6 col-xs-12">
														<div class="mega-menu-home">
															...
															<ul class="list-none">
																<li><a href="{{asset('assets/client/home-glasses-light.html')}}" class="silver">Light version Demo</a></li>
																<li><a href="{{asset('assets/client/home-glasses-dark.html')}}" class="silver">Dark version Demo</a></li>
															</ul>
														</div>
														<div class="mega-menu-home">
															<h2 class="title18 play-font font-italic dark">Home Watch</h2>
															<ul class="list-none">
																<li><a href="{{asset('assets/client/home-watches-light.html')}}" class="silver">Light version Demo</a></li>
																<li><a href="{{asset('assets/client/home-watches-dark.html')}}" class="silver">Dark version Demo</a></li>
															</ul>
														</div>
														<div class="mega-menu-home">
															<h2 class="title18 play-font font-italic dark">Home Fashion</h2>
															<ul class="list-none">
																<li><a href="{{asset('assets/client/home-fashion-light.html')}}" class="silver">Light version Demo</a></li>
																<li><a href="{{asset('assets/client/home-fashion-dark.html')}}" class="silver">Dark version Demo</a></li>
															</ul>
														</div>
													</div>
												</div>
												...
												<div class="row">
													<div class="col-md-3 col-sm-4 col-xs-12">
														<div class="mega-list-cat">
															<h2 class="title18 font-bold text-uppercase play-font">CATEGORY PAGE</h2>
															<ul class="list-none">
													...
													<div class="col-md-3 col-sm-4 col-xs-12">
														<div class="mega-list-cat">
															<h2 class="title18 font-bold text-uppercase play-font">product PAGE</h2>
															<ul class="list-none">
													...
													<div class="col-md-3 col-sm-4 col-xs-12">
														<div class="mega-list-cat">
															<h2 class="title18 font-bold text-uppercase play-font">more...</h2>
															<ul class="list-none">
